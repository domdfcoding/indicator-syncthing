...
github_repository = "indicator-syncthing"
github_url = f"https://github.com/{github_username}/{github_repository}"

rst_prolog = f""".. |pkgname| replace:: indicator-syncthing
.. |pkgname2| replace:: ``indicator-syncthing``
...
language = "en"
package_root = "indicator_syncthing"
